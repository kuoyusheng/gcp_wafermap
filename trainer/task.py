...
def get_args():
    ...
    args_parser.add_argument(
        "--optimizer", help="optimizer default to adam", default="adam"
    )
    args_parser.add_argument(
        "--base-model",
        help="base model for SSL",
        default="resnet18",
    )
    args_parser.add_argument("--dim", help="model for projector dim", default=1024)
    args_parser.add_argument("--pred-dim", help="predictive dim", default=256)
