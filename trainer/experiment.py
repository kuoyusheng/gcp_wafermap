...
def simsiam_train(model, train_loader, criterion, optimizer, epoch, device):
...
def run(args):
    ...
    # Open our dataset
    train_loader = inputs.load_train_data(args, device)
    ...
    for epoch in range(1, args.num_epochs + 1):
        simsiam_train(
            sequential_model, train_loader, criterion, optimizer, epoch, device
        )
